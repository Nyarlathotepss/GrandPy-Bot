STOP_WORDS = ["sais", "donne", "papy", "papybot", "grandpy-bot", "GrandPy Bot", "informations", "infos", "salutation",
              "hello", "salut", "bonjour", "a", "abord", "absolument", "afin", "ah", "ai", "aie", "ailleurs", "ainsi",
              "ait", "allaient", "allo", "allons", "allô", "alors", "anterieur", "anterieure", "anterieures", "apres",
              "après", "as", "assez", "attendu", "au", "aucun", "aucune", "aujourd", "aujourd'hui", "aupres", "auquel",
              "aura", "auraient", "aurait", "auront", "aussi", "autre", "autrefois", "autrement", "autres", "autrui",
              "aux", "auxquelles", "auxquels", "avaient", "avais", "avait", "avant", "avec", "avoir", "avons", "ayant",
              ...
              "neuf", "neuvième", "ni", "nombreuses", "nombreux", "non", "nos", "notamment", "nous", "nous-mêmes",
              ...
              "partant", "particulier", "particulière", "particulièrement", "pas", "passé", "pendant", "pense",
              "permet", "personne", "peu", "peut", "peuvent", "peux", "pff", "pfft", "pfut", "pif", "pire", "plein",
...
MAPS_URL = "https://maps.googleapis.com/maps/api/place/findplacefromtext/json?"

GRANDPY_BOT_ANSWERS = ["Voila ce que je sais sur ta demande mon petit :", "Hummm je crois me souvenir de ceci sur"
                                                                          "ta question mon canard:",
                       "Mais bien sur que j'ai une information sur lieu :"]
...
GRANDPY_BOT_KNOW_ONLY_PLACE = "Je connais l'endroit mais je n'ai pas d'infos mon poussin !."
